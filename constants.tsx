...
export const getAssetPath = (path: string): string => {
  ...
  const basePath = process.env.NODE_ENV === 'production' ? '/ninjago' : '';
...
export const VIDEO_CATALOG: VideoInfo[] = [
  ...
  { 
    ...
    fileName: "publicvideosvideoplayback.mp4",
    path: getAssetPath("/videos/publicvideosvideoplayback.mp4"),
  ...
  // === VIDEOS NUEVOS (27 DE JULIO) ===
  { 
    id: "july1", 
    title: "Video 27 Julio - 12:58 PM", 
    fileName: "Generated File July 27, 2025 - 12_58PM.mp4",
    path: getAssetPath("/videos/Generated File July 27, 2025 - 12_58PM.mp4"),
    description: "Contenido generado - 27 de Julio 2025"
  },
  { 
    id: "july2", 
    title: "Video 27 Julio - 1:00 PM", 
